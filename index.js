 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,ct={attribute:!0,type:String,converter:v,reflect:!1,hasChanged:b},ht=(t=ct,e,i)=>{const{kind:s,metadata:n}=i;let o=globalThis.litPropertyMetadata.get(n);if(void 0===o&&globalThis.litPropertyMetadata.set(n,o=new Map),o.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const n=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,n,t)},init(e){return void 0!==e&&this.P(s,void 0,t),e}}}if("setter"===s){const{name:s}=i;return function(i){const n=this[s];e.call(this,i),this.requestUpdate(s,n,t)}}throw Error("Unsupported decorator location: "+s)};function dt(t){return(e,i)=>"object"==typeof i?ht(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,s?{...t,wrapped:!0}:t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}function pt(t){return dt({...t,state:!0,attribute:!1})}var ut,_t;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ut||(ut={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(_t||(_t={}));let gt=class extends rt{constructor(){super(...arguments),this._isOpen=!1}showDialog(t){this._entities=t.entities,this._isOpen=!0,"off"===this._getState(this._entities.toggle_inclinometer)&&this.hass.callService("homeassistant","turn_on",{entity_id:this._entities.toggle_inclinometer.entity_id})}render(){var t,e;if(!this._isOpen)return q;const{orientation:i,calibrate_pitch:s,calibrate_roll:n,reset_pitch_adjustment_angle:o,reset_roll_adjustment_angle:r,pitch_adjustment_angle:a,roll_adjustment_angle:l,adjusted_pitch_angle:c,adjusted_roll_angle:h}=this._entities,d=(null===(e=null===(t=this.hass.states[i.entity_id])||void 0===t?void 0:t.attributes)||void 0===e?void 0:e.options)||[];return V`
      <ha-dialog
        open
