 ...
 */}function pt(t){return dt({...t,state:!0,attribute:!1})}let ut=class extends rt{constructor(){super(),this.angle=0,this.inverted=!1,this.name=""}render(){const t=isNaN(Number(this.angle))?"-":`${Math.abs(Number(this.angle))}°`,e=this.inverted?-1*this.angle:this.angle;return V`
  ...
  `,t([dt({attribute:!1}),e("design:type",Number)],ut.prototype,"angle",void 0),t([dt({attribute:!1}),e("design:type",Object)],ut.prototype,"hass",void 0),t([dt({attribute:!1}),e("design:type",Boolean)],ut.prototype,"inverted",void 0),t([dt(),e("design:type",String)],ut.prototype,"name",void 0),ut=t([lt("smartvan-io-inclinometer-indicator"),e("design:paramtypes",[])],ut),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(_t||(_t={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(gt||(gt={}));var vt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n};let ft=class extends rt{constructor(){super(...arguments),this._possibleDevices=[],this._config={type:"custom:smartvan-io-inclinometer",device:""}}setConfig(t){this._config=Object.assign({},t)}firstUpdated(){var t;this._possibleDevices=Object.values(this.hass.devices).filter((t=>"smartvanio"===t.manufacturer)).filter((t=>"inclinometer"===t.model)),(null===(t=this._config)||void 0===t?void 0:t.device)?this._entities=this._getEntitiesForDevice(this._config.device):1===this._possibleDevices.length&&(this._entities=this._getEntitiesForDevice(this._possibleDevices[0].id),vt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{device:this._possibleDevices[0].id})}))}render(){var t,e,i;if(!this.hass||!this._config)return W;const s=!this._config.device||(null===(t=this._getEntityStates())||void 0===t?void 0:t.some((t=>"Unavailable"===t)));return V`
      <div class="card-config">
        ${s&&V`<ha-alert alert-type="error" class="alert"
        ...
        >
          ${["Option 1","Option 2","Option 3","Option 4"].map((t=>V`<mwc-list-item .value=${t}> ${t} </mwc-list-item>`))}
        </ha-select>
        ...
        <div class="input-group">
          <ha-textfield
            ...
            .value=${this._getState(null===(e=this._entities)||void 0===e?void 0:e.pitch_adjustment_angle)}
          ...
          <div class="buttons">
            <mwc-button
              slot="primaryAction"
              disable=${!this._config.device}
              @click=${()=>{var t;return this._setCalibration(null===(t=this._entities)||void 0===t?void 0:t.reset_pitch_adjustment_angle.entity_id)}}
            >
              Reset
            </mwc-button>
            <mwc-button
              slot="primaryAction"
              disable=${!this._config.device}
              @click=${()=>{var t;return this._setCalibration(null===(t=this._entities)||void 0===t?void 0:t.calibrate_pitch.entity_id)}}
            >
              Calibrate
            </mwc-button>
            <mwc-button
        ...
        <div class="input-group">
          <ha-textfield
            ...
            disable=${!this._config.device}
            .value=${this._getState(null===(i=this._entities)||void 0===i?void 0:i.roll_adjustment_angle)}
          ...
          <div class="buttons">
            <mwc-button
              slot="primaryAction"
              disable=${!this._config.device}
              @click=${()=>{var t;return this._setCalibration(null===(t=this._entities)||void 0===t?void 0:t.reset_roll_adjustment_angle.entity_id)}}
            >
              Reset
            </mwc-button>
            <mwc-button
              slot="primaryAction"
              disable=${!this._config.device}
              @click=${()=>{var t;return this._setCalibration(null===(t=this._entities)||void 0===t?void 0:t.calibrate_roll.entity_id)}}
            >
              Calibrate
            </mwc-button>
            <mwc-button
    ...
    `}_getEntityStates(){if(!this._entities)return[];Object.values(this._entities).map((t=>this.hass.states[t.entity_id].state))}_findEntitiesByDeviceId(t){return this.hass?Object.values(this.hass.entities).filter((e=>e.device_id===t)):[]}_getEntitiesForDevice(t){if(!t)return{};return this._findEntitiesByDeviceId(t).reduce(((t,e)=>{const i=e.name.replace(/ /g,"_").toLowerCase();return Object.assign(Object.assign({},t),{[i]:e})}),{})}_getState(t){return t?this.hass.states[t.entity_id].state:""}_toggleInverted(t){const e=`${t}_inverted`,i=this._config[e];vt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{[e]:!i})})}_setDevice(t){vt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{device:this._possibleDevices.find((e=>e.id===t)).id})})}_setOrientation(t){vt(this,"config-changed",{config:Object.assign(Object.assign({},this._config),{orientation:t})})}_setCalibration(t){this.hass.callService("button","press",{entity_id:t})}_setValue(t,e){this.hass.callService("number","set_value",{entity_id:t,value:e})}};ft.styles=a`
    .card-config {
      display: flex;
