 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var dt,pt,ut;null===(dt=window.HTMLSlotElement)||void 0===dt||dt.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(pt||(pt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ut||(ut={}));var vt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n};class _t extends ot{constructor(){super(...arguments),this._newConfig=Object.assign({},this.config)}showDialog(t){this._entities=t.entities,"off"===this._getState(this._entities.toggle_inclinometer)&&this.hass.callService("homeassistant","turn_on",{entity_id:this._entities.toggle_inclinometer.entity_id})}render(){var t,e;if(!this._entities)return z``;const{orientation:i,calibrate_pitch:s,calibrate_roll:n,reset_pitch_adjustment_angle:o,reset_roll_adjustment_angle:r,pitch_adjustment_angle:l,roll_adjustment_angle:a,adjusted_pitch_angle:c,adjusted_roll_angle:h}=this._entities,d=(null===(e=null===(t=this.hass.states[i.entity_id])||void 0===t?void 0:t.attributes)||void 0===e?void 0:e.options)||[];return z`
    ...
    `}_closeDialog(){vt(this,"dialog-closed","smartvan-io-inclinometer-dialog"),this._entities={}}_getState(t){return this.hass.states[t.entity_id].state}_setOrientation(t){this.hass.callService("select","select_option",{entity_id:this._entities.orientation.entity_id,option:t})}_setCalibration(t){this.hass.callService("button","press",{entity_id:t})}_setValue(t,e){this.hass.callService("number","set_value",{entity_id:t,value:e})}}_t.styles=l`
  ...
  `,t([ct({attribute:!1}),e("design:type",String)],mt.prototype,"angle",void 0),t([ct(),e("design:type",String)],mt.prototype,"name",void 0),mt=t([lt("smartvan-io-inclinometer-indicator"),e("design:paramtypes",[])],mt);let $t=class extends ot{constructor(){super(...arguments),this.config={device:""},this._pitchState="",this._rollState="",this._isEnabled=!1}updated(){this._pitchState=this._getState(this.entities.adjusted_pitch_angle),this._rollState=this._getState(this.entities.adjusted_roll_angle),this._isEnabled="on"===this._getState(this.entities.toggle_inclinometer)}firstUpdated(){this.entities=this._getEntitiesForDevice(this.config.device)}render(){if(!this.config)return z`<ha-card>Loading...</ha-card>`;const t=parseFloat(this._pitchState),e=parseFloat(this._rollState);return z`
      <ha-card>
        <ha-dialog-header>
  ...
  `,t([ct({attribute:!1}),e("design:type",Object)],$t.prototype,"hass",void 0),t([ct({attribute:!1}),e("design:type",Object)],$t.prototype,"config",void 0),t([ct({attribute:!1}),e("design:type",Object)],$t.prototype,"entities",void 0),t([ht(),e("design:type",Object)],$t.prototype,"_pitchState",void 0),t([ht(),e("design:type",Object)],$t.prototype,"_rollState",void 0),t([ht(),e("design:type",Boolean)],$t.prototype,"_isEnabled",void 0),$t=t([lt("smartvan-io-inclinometer")],$t);
